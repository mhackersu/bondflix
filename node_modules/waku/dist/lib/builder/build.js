...
import { CLIENT_MODULE_MAP, CLIENT_PREFIX, renderHtml } from '../renderers/html-renderer.js';
...
const analyzeEntries = async (rootDir, config)=>{
    ...
    const clientEntryFiles = Object.fromEntries(Array.from(clientFileSet).map((fname, i)=>[
